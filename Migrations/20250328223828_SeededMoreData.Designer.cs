...
namespace RepairAndConstruction.Migrations
{
    ...
    [Migration("20250328223828_SeededMoreData")]
            ...
            modelBuilder.Entity("RepairAndConstruction.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BookingDate = new DateTime(2025, 3, 29, 0, 38, 27, 694, DateTimeKind.Local).AddTicks(7261),
                            CustomerId = 1,
                            JobOfferId = 1,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 2,
                            BookingDate = new DateTime(2025, 3, 30, 0, 38, 27, 694, DateTimeKind.Local).AddTicks(7293),
                            CustomerId = 2,
                            JobOfferId = 2,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 3,
                            BookingDate = new DateTime(2025, 3, 31, 0, 38, 27, 694, DateTimeKind.Local).AddTicks(7297),
                            CustomerId = 3,
                            JobOfferId = 3,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 4,
                            BookingDate = new DateTime(2025, 4, 1, 0, 38, 27, 694, DateTimeKind.Local).AddTicks(7299),
                            CustomerId = 4,
                            JobOfferId = 4,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 5,
                            BookingDate = new DateTime(2025, 4, 2, 0, 38, 27, 694, DateTimeKind.Local).AddTicks(7300),
                            CustomerId = 1,
                            JobOfferId = 5,
                            Status = "Confirmed"
                        });
