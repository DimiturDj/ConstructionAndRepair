...
namespace RepairAndConstruction.Migrations
{
    ...
    [Migration("20250406103732_SeedAppUsersFix")]
    partial class SeedAppUsersFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RepairAndConstruction.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BookingDate = new DateTime(2025, 4, 6, 13, 37, 31, 753, DateTimeKind.Local).AddTicks(9692),
                            CustomerId = 1,
                            JobOfferId = 1,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 2,
                            BookingDate = new DateTime(2025, 4, 7, 13, 37, 31, 753, DateTimeKind.Local).AddTicks(9736),
                            CustomerId = 2,
                            JobOfferId = 2,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 3,
                            BookingDate = new DateTime(2025, 4, 8, 13, 37, 31, 753, DateTimeKind.Local).AddTicks(9739),
                            CustomerId = 3,
                            JobOfferId = 3,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 4,
                            BookingDate = new DateTime(2025, 4, 9, 13, 37, 31, 753, DateTimeKind.Local).AddTicks(9741),
                            CustomerId = 4,
                            JobOfferId = 4,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 5,
                            BookingDate = new DateTime(2025, 4, 10, 13, 37, 31, 753, DateTimeKind.Local).AddTicks(9743),
                            CustomerId = 1,
                            JobOfferId = 5,
                            Status = "Confirmed"
                        });
