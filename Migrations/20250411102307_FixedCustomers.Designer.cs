...
namespace RepairAndConstruction.Migrations
{
    ...
    [Migration("20250411102307_FixedCustomers")]
    partial class FixedCustomers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RepairAndConstruction.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BookingDate = new DateTime(2025, 4, 11, 13, 23, 6, 612, DateTimeKind.Local).AddTicks(9545),
                            CustomerId = 1,
                            JobOfferId = 1,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 2,
                            BookingDate = new DateTime(2025, 4, 12, 13, 23, 6, 612, DateTimeKind.Local).AddTicks(9582),
                            CustomerId = 2,
                            JobOfferId = 2,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 3,
                            BookingDate = new DateTime(2025, 4, 13, 13, 23, 6, 612, DateTimeKind.Local).AddTicks(9586),
                            CustomerId = 3,
                            JobOfferId = 3,
                            Status = "Confirmed"
                        },
                        ...
                        {
                            Id = 4,
                            BookingDate = new DateTime(2025, 4, 14, 13, 23, 6, 612, DateTimeKind.Local).AddTicks(9588),
                            CustomerId = 4,
                            JobOfferId = 4,
                            Status = "Pending"
                        },
                        ...
                        {
                            Id = 5,
                            BookingDate = new DateTime(2025, 4, 15, 13, 23, 6, 612, DateTimeKind.Local).AddTicks(9590),
                            CustomerId = 1,
                            JobOfferId = 5,
                            Status = "Confirmed"
                        });
